...
// function that returns the winner of the tournament. The input arrays are named competitions  and results , respectively. The competitions array has elements in the form of
// [homeTeam, awayTeam] , where each team is a string of at most 30 characters representing the name of the team. The results  array contains information about the winner of each
// corresponding competition in the competitions  array. Specifically, results[i]  denotes the winner of competitions[i] , where a  1  in the  array means that the home team
...
//     ["Python", "HTML"],
//   ]
// results = [0, 0, 1] (1 - home team, 0 - away team)
...
function tournamentWinner(competitions, results) {
  ...
  for (let i = 0; i < competitions.length; i++) {
    ...
    scoreboard[winner] = (scoreboard[winner] || 0) + 3
